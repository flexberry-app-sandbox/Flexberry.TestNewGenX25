...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen x2 language l');

test('testing new-platform-test-new-gen-x2-language-l', function(assert) {
  visit('/new-platform-test-new-gen-x2-language-l');
