...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen x2 book l');

test('testing new-platform-test-new-gen-x2-book-l', function(assert) {
  visit('/new-platform-test-new-gen-x2-book-l');
