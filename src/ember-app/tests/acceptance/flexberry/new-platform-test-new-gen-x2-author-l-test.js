...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen x2 author l');

test('testing new-platform-test-new-gen-x2-author-l', function(assert) {
  visit('/new-platform-test-new-gen-x2-author-l');
