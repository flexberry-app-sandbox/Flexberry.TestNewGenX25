...
moduleForAcceptance('[AGAT] Acceptance | new platform test new gen x2 country l');

test('testing new-platform-test-new-gen-x2-country-l', function(assert) {
  visit('/new-platform-test-new-gen-x2-country-l');
