...
moduleForModel('new-platform-test-new-gen-x2-country', 'Unit | Serializer | new-platform-test-new-gen-x2-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:new-platform-test-new-gen-x2-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
